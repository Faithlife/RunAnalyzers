# Contributing to Faithlife.RunAnalyzers
...
* Clone the repository: `git clone https://github.com/Faithlife/RunAnalyzers.git`
* `cd RunAnalyzers`
* `dotnet test tests/Faithlife.RunAnalyzers.Tests`
